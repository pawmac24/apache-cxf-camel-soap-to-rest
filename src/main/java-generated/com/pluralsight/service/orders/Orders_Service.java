 ...
 * 2016-09-23T15:55:47.411+02:00
 * Generated source version: 2.7.6
 * 
 */
@WebServiceClient(name = "Orders", 
                  wsdlLocation = "file:/D:/JBOSS_FUSE/pluralsight/apache-cxf-camel-soap-to-rest/src/main/resources/wsdl/Orders.wsdl",
...
public class Orders_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/JBOSS_FUSE/pluralsight/apache-cxf-camel-soap-to-rest/src/main/resources/wsdl/Orders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/D:/JBOSS_FUSE/pluralsight/apache-cxf-camel-soap-to-rest/src/main/resources/wsdl/Orders.wsdl");
        }
        WSDL_LOCATION = url;
    }
